...
EMBEDDING_TEXTS_PER_BATCH: int = _get_int_env('EMBEDDING_TEXTS_PER_BATCH', 100)
EMBEDDING_RPM: int = _get_int_env('EMBEDDING_RPM', 60)
EMBEDDING_MAX_TOKENS: int = _get_int_env('EMBEDDING_MAX_TOKENS', 450)
